...
function drawScene(gl, programInfo, buffers, deltaTime) {
  ...
  var z = -document.getElementById("z").value / 100;
  var angleX = document.getElementById("angleX").value / 100;
  var angleY = document.getElementById("angleY").value / 100;
  var angleZ = document.getElementById("angleZ").value / 100;
  var scales = document.getElementById("scale").value;
